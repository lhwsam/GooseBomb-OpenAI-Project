...
- 보스의 정확한 다음 이동 셀 고스트를 제거했다. Core가 확정한 다중 cardinal 이동만 presenter가 보간하고, 돌진 차선·착탄 예약·자폭병 소환 셀·현재 parity 행만 예고한다. 보스 투척은 고정 포물선으로 날아 착탄 순간 기존 `BombSimulation`을 점유하고 그때 fuse를 시작한다.
