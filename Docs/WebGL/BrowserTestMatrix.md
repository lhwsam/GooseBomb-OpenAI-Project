...
- 추격자 이동, 차저 예고·돌진·논리 이동, 접촉 피해, 논리 이탈, 두 정의의 폭탄 설치, 실제 fuse 자기 폭발, 두 번째 방 대각선 파괴 블록의 광역 동시 파괴, 두 번째 폭탄 유도 처치·방 클리어, 성공한 Core 교체, pause/resume.
