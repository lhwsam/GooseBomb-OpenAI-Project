...
- 추격자 BFS 이동, 차저 차선 획득 이동·방향/최대 거리 전체 예고·고정 돌진·충돌 회복, 갑옷 적 첫 피격 상태/속도 변화와 두 번째 피격 사망, 접촉 피해, 논리 이탈, 두 정의의 폭탄 설치, 실제 fuse 자기 폭발, 파괴 블록의 폭발 파괴, 폭탄 유도 처치·방 클리어, 성공한 Core 교체.
