...
- 모든 방에서 플레이어 현재/최대 체력과 bar가 좌상단에 읽히고, 보스방에서만 보스 현재/최대 체력과 phase가 상단 중앙에 나타나며 무기 HUD·전투 공간·pause/완료/실패 overlay와 충돌하지 않는지 캡처로 확인한다.
